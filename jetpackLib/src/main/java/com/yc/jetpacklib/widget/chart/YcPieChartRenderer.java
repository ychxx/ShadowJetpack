...
public class YcPieChartRenderer extends PieChartRenderer {
    ...
    public YcPieChartRenderer(PieChart chart) {
        this(chart, chart.getAnimator(), chart.getViewPortHandler());
    }

    public YcPieChartRenderer(PieChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            mValueLinePaint.setColor(dataSet.getColor(i));
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    if (dataSet.getColor(i) != ColorTemplate.COLOR_NONE) {
